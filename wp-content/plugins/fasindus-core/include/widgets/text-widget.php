 ...
 */
class fasindus_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'text-widget',
      FASINDUS_THEME_NAME_PLUGIN . esc_html__( ': Text Widget', 'fasindus' ),
      array(
        'classname'   => 'text-widget',
        'description' => FASINDUS_THEME_NAME_PLUGIN . esc_html__( ' widget that displays contents.', 'fasindus' )
      )
    );
  }
...
add_action( 'widgets_init', function() { register_widget( "fasindus_text_widget" ); } );