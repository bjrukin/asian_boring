...
class fasindus_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-navigation-widget',
      FASINDUS_THEME_NAME_PLUGIN . esc_html__( ': Navigation', 'fasindus' ),
      array(
        'classname'   => 'link-widget',
        'description' => FASINDUS_THEME_NAME_PLUGIN . esc_html__( ' widget that displays navigations list.', 'fasindus' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__( 'Select Menu List :', 'fasindus' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__( 'Display Menu Children :', 'fasindus' ),
      'help' => esc_html__( 'This only shows first level of child menus.', 'fasindus' ),
    );
...
add_action( 'widgets_init', function() { register_widget( "fasindus_navigation_widget" ); } );
