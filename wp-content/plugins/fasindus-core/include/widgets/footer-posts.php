 ...
 */
class fasindus_footer_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-footer-blog',
      FASINDUS_THEME_NAME_PLUGIN . esc_html__( ': Footer Posts', 'fasindus' ),
      array(
        'classname'   => 'recent-post-widget',
        'description' => FASINDUS_THEME_NAME_PLUGIN . esc_html__( ' widget that displays footer posts.', 'fasindus' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $instance   = wp_parse_args( $instance, array(
      'title'    => esc_html__( 'Footer Posts', 'fasindus' ),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
  ...
  public function widget( $args, $instance ) {
    ...
    if ($fasindus_rpw->have_posts()) : while ($fasindus_rpw->have_posts()) : $fasindus_rpw->the_post();
      ...
      if (!empty( $post_img )) {
        ...
        $post_img = FASINDUS_PLUGIN_IMGS.'/70X80.jpg';
      } ?>
    <div class="post">
...
add_action( 'widgets_init', function() { register_widget( "fasindus_footer_posts" ); } );