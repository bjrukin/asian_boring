 ...
 */
function fasindus_import_files() {
  return array(
    array(
      'import_file_name'           => 'Fasindus',
      'import_file_url'            => trailingslashit( FASINDUS_PLUGIN_URL ) . 'include/demo/content.xml',
      'local_import_csf'           => array(
        array(
          'file_path'   => trailingslashit( FASINDUS_PLUGIN_URL ) . 'include/demo/theme-options.json',
          'option_name' => '_cs_options',
        ),
      ),
      'import_widget_file_url'     => trailingslashit( FASINDUS_PLUGIN_URL ) . 'include/demo/widget.wie',
      'preview_url'                => 'https://quomodothemes.website/fasindus/',
      'import_notice'                => '',
      'import_preview_image_url'   => 'https://quomodothemes.website/fasindus/wp-content/themes/fasindus/screenshot.png',
    ),
  );
}
add_filter( 'pt-ocdi/import_files', 'fasindus_import_files' );
...
/**
 * fasindus_after_import_setup
 * @return Front Page, Post Page & Menu Set
 */
function fasindus_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'fasindus_after_import_setup' );

$locations = get_theme_mod( 'nav_menu_locations' );


// Install Demos Menu - Menu Edited
function fasindus_core_one_click_page( $default_settings ) {
  $default_settings['parent_slug'] = 'themes.php';
  $default_settings['page_title']  = esc_html__( 'Install Demo', 'fasindus-core' );
  $default_settings['menu_title']  = esc_html__( 'Install Demo', 'fasindus-core' );
  $default_settings['capability']  = 'import';
  $default_settings['menu_slug']   = 'install_demos';

  return $default_settings;
}
add_filter( 'pt-ocdi/plugin_page_setup', 'fasindus_core_one_click_page' );

// Model Popup - Width Increased
function fasindus_ocdi_confirmation_dialog_options ( $options ) {
...
add_filter( 'pt-ocdi/confirmation_dialog_options', 'fasindus_ocdi_confirmation_dialog_options', 10, 1 );


function fasindus_ocdi_plugin_intro_text( $default_text ) {
    $default_text .= '
  <h1>Import Demo</h1>
    <div class="one-click-import-img">
      <img src="https://quomodothemes.website/fasindus/wp-content/themes/fasindus/screenshot.png" alt="img">
    </div>
    <div class="fasindus-core_intro-text demo-one-click">
      <div id="poststuff" class="postbox-wrap clearfix">
        ...
        <div class="box-inner important-notes">
          ...
          <div class="inside">
            ...
            <a href="https://quomodothemes.website/fasindus/doc" class="button-primary" target="_blank">Docs</a>
            <a href="https://support.quomodothemes.website/" class="button-primary" target="_blank">Support</a>
            <a href="https://themeforest.net/user/quomodotheme/portfolio" class="button-primary" target="_blank">Item Page</a>
          </div>
        </div>
        </div>
      </div>
...
add_filter( 'pt-ocdi/plugin_intro_text', 'fasindus_ocdi_plugin_intro_text' );