<?php
/*
 * Fasindus Theme Widgets
 * Author & Copyright:quomodotheme
 * URL: http://themeforest.net/user/quomodotheme
 */

if ( ! function_exists( 'fasindus_widget_init' ) ) {
	function fasindus_widget_init() {
		if ( function_exists( 'register_sidebar' ) ) {

			// Main Widget Area
			register_sidebar(
				array(
					'name' => esc_html__( 'Main Widget Area', 'fasindus' ),
					'id' => 'sidebar-1',
					'description' => esc_html__( 'Appears on posts and pages.', 'fasindus' ),
	    ...
	    if( $footer_widgets ) {
	      ...
	      for( $i = 0; $i < $length; $i++ ) {
	        ...
	        register_sidebar( array(
	          'id'            => 'footer-' . $num,
	          'name'          => esc_html__( 'Footer Widget ', 'fasindus' ). $num,
	          'description'   => esc_html__( 'Appears on footer section.', 'fasindus' ),
	...
	add_action( 'widgets_init', 'fasindus_widget_init' );
}