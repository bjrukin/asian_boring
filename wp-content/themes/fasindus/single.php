 ...
 */
	...
	// Theme Options
	$fasindus_single_comment = cs_get_option( 'single_comment_form' );
...
?>
<div class="blog-single-section section-padding <?php echo esc_attr( $fasindus_content_padding .' '. $fasindus_sidebar_class ); ?>" style="<?php echo esc_attr( $fasindus_custom_padding ); ?>">
