...
// Theme Options
$fasindus_sidebar_position = cs_get_option( 'service_sidebar_position' );
$fasindus_single_comment = cs_get_option( 'service_comment_form' );
$fasindus_sidebar_position = $fasindus_sidebar_position ? $fasindus_sidebar_position : 'left-sidebar';
// Sidebar Position
if ( $fasindus_sidebar_position === 'sidebar-hide' ) {
	$fasindus_layout_class = 'col col-md-12';
	$fasindus_sidebar_class = 'hide-sidebar';
} elseif ( $fasindus_sidebar_position === 'sidebar-left' ) {
	$fasindus_layout_class = 'col col-md-9 col-md-push-3';
	$fasindus_sidebar_class = 'left-sidebar';
} else {
	$fasindus_layout_class = 'col col-md-9';
	$fasindus_sidebar_class = 'right-sidebar';
} ?>
<div class="service-single-section section-padding <?php echo esc_attr( $fasindus_content_padding .' '. $fasindus_sidebar_class ); ?>" style="<?php echo esc_attr( $fasindus_custom_padding ); ?>">
	<div class="container">
		<div class="row">
